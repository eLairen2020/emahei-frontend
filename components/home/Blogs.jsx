...
export default function Blog() {
    ...
    <div className="text-center mb-1">
        <h1 className="sm:text-3xl text-2xl font-medium title-font text-gray-900 mb-4">From Our Blogs</h1>
        <div className="flex mt-6 justify-center">
                    <p >
                        <a className="text-gray-600 hover:text-sky-800 hover:font-semibold
